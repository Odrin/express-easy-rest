...
var ApplicationInstance = (function () {
    ...
    ApplicationInstance.prototype.configAuthProvider = function () {
        ...
        this.express.use(function (req, res, next) {
            if (!_this.authenticationProvider) {
                context_data_provider_1.ContextDataProvider.setData(req, 'principal', null);
                return next();
            }
            _this.authenticationProvider.onAuthentication(req, res)
                .then(function (principal) {
                context_data_provider_1.ContextDataProvider.setData(req, 'principal', principal || null);
                next();
            })
    ...
    ApplicationInstance.prototype.configErrorHandlers = function () {
        var _this = this;
    ...
    ApplicationInstance.prototype.configRouter = function () {
        for (var _i = 0, _a = this.controllers; _i < _a.length; _i++) {
            ...
            for (var _b = 0, actions_1 = actions; _b < actions_1.length; _b++) {
                ...
                var dispatcher = new controller_dispatcher_1.ControllerDispatcher(controller, action, bindings, returnType);
